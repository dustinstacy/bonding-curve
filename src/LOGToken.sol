...
contract LOGToken is ERC20Burnable {
    ...
    LogarithmicBondingCurve private immutable i_bondingCurve;
    ...
    constructor(
        ...
        i_bondingCurve = LogarithmicBondingCurve(_bcAddress);
    }
    ...
    //     if (balance < amount) {
    //         revert LOGToken__BurnAmountExceedsBalance();
    //     }
