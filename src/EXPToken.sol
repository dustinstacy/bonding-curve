...
///         It is designed to work with a bonding curve that is defined by a scaling factor.
contract EXPToken is ERC20Burnable {
    ...
    /// @dev In the case of an upgradeable implementation, this should be a proxy.
    ...
    ///         It's specified in basis points, where 100 basis points = 1%.
