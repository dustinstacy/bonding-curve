...
library Power {
     ...
     */
    function getMaxExp(uint256 index) internal pure returns (uint256) {
        require(index < 128, "Index out of bounds");
        uint144[128] memory maxExpArray = [
            0x6bffffffffffffffffffffffffffffffff,
            0x67ffffffffffffffffffffffffffffffff,
            0x637fffffffffffffffffffffffffffffff,
            0x5f6fffffffffffffffffffffffffffffff,
            0x5b77ffffffffffffffffffffffffffffff,
            0x57b3ffffffffffffffffffffffffffffff,
            0x5419ffffffffffffffffffffffffffffff,
            0x50a2ffffffffffffffffffffffffffffff,
            0x4d517fffffffffffffffffffffffffffff,
            0x4a233fffffffffffffffffffffffffffff,
            0x47165fffffffffffffffffffffffffffff,
            0x4429afffffffffffffffffffffffffffff,
            0x415bc7ffffffffffffffffffffffffffff,
            0x3eab73ffffffffffffffffffffffffffff,
            0x3c1771ffffffffffffffffffffffffffff,
            0x399e96ffffffffffffffffffffffffffff,
            0x373fc47fffffffffffffffffffffffffff,
            0x34f9e8ffffffffffffffffffffffffffff,
            0x32cbfd5fffffffffffffffffffffffffff,
            0x30b5057fffffffffffffffffffffffffff,
            0x2eb40f9fffffffffffffffffffffffffff,
            0x2cc8340fffffffffffffffffffffffffff,
            0x2af09481ffffffffffffffffffffffffff,
            0x292c5bddffffffffffffffffffffffffff,
            0x277abdcdffffffffffffffffffffffffff,
            0x25daf6657ffffffffffffffffffffffffff,
            0x244c49c65fffffffffffffffffffffffff,
            0x22ce03cd5fffffffffffffffffffffffff,
            0x215f77c047ffffffffffffffffffffffff,
            0x1fffffffffffffffffffffffffffffffff,
            0x1eaefdbdabffffffffffffffffffffffff,
            0x1d6bd8b2ebffffffffffffffffffffffff,
            ...
            0x0a4b16f74ee4bb207ffffffffffffffffff,
            0x09deaf736ac1f569ffffffffffffffffff,
            0x0976bd9952c7aa957ffffffffffffffffff,
            0x09131271922eaa606ffffffffffffffffff,
            0x08b380f3558668c46ffffffffffffffffff,
        ...
        return maxExpArray[index];
    }
    /**
     * General Description:
     *       Determine a value of precision.
     *       Calculate an integer approximation of (_newReserveBalance / _reserveBalance) ^ (_reserverRatio / maxReserveRatio) * 2 ^ precision.
     ...
     *       This functions assumes that "_reserverRatio < 2 ^ 256 / log(MAX_NUM - 1)", otherwise the multiplication should be replaced with a "safeMul".
     */

    function power(uint256 _newReserveBalance, uint256 _reserveBalance, uint32 _reserverRatio, uint32 maxReserveRatio)
        external
        pure
        returns (uint256, uint8)
    {
        require(_newReserveBalance < MAX_NUM, "newReserveBalance exceeds max value.");
        require(_newReserveBalance >= _reserveBalance, "Bases < 1 are not supported.");

        uint256 baseLog;
        uint256 base = _newReserveBalance * FIXED_1 / _reserveBalance;
        ...
        uint256 baseLogTimesExp = baseLog * _reserverRatio / maxReserveRatio;
