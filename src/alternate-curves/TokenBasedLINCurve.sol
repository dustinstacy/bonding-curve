...
/// @dev    Pricing is based on full discrete tokens, not continuous tokens.
contract TokenBasedLINCurve is Initializable, OwnableUpgradeable, UUPSUpgradeable {
